...
class PhoneAssignments():
    ...
    def add_employee(self, employee):
        ...
        if any(employed.id == employee.id for employed in self.employees):
            raise PhoneError('Employee ID already exists.')
        elif any(employed.id != employee.id for employed in self.employees):
